  ...
  return (
    <div className="carousel md:w-full md:h-[600px]">
      <div id="slide1" className="carousel-item relative w-full ">
        ...
        <div className="absolute rounded-xl h-full flex items-center left-0 right-0 bottom-0  bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)]">
          <div className="text-white space-y-7 pl-12 w-1/2">
            <h2 className="sm:text-6xl font-bold">
